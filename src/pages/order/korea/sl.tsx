...
const staticData = {
    ...
    totalPages:2,
    content:[
        {designId:"204-612", pic:1, sum:5, customer:"SL",size:"M",color:"白色",status:"OK",note:"加急"},
        {designId:"204-612", pic:2, sum:5, customer:"SL",size:"M",color:"白色",status:"OK",note:"加急"},
        {designId:"204-612", pic:6, sum:5, customer:"SL",size:"M",color:"白色",status:"OK",note:"加急"},
        {designId:"204-612", pic:4, sum:5, customer:"SL",size:"M",color:"白色",status:"OK",note:"加急"},
        {designId:"204-612", pic:5, sum:5, customer:"SL",size:"M",color:"白色",status:"OK",note:"加急"},
        {designId:"204-612", pic:1, sum:5, customer:"SL",size:"M",color:"白色",status:"OK",note:"加急"},
        {designId:"204-612", pic:2, sum:5, customer:"SL",size:"M",color:"白色",status:"OK",note:"加急"},
        {designId:"204-612", pic:4, sum:5, customer:"SL",size:"M",color:"白色",status:"OK",note:"加急"},
        {designId:"204-612", pic:4, sum:5, customer:"SL",size:"M",color:"白色",status:"OK",note:"加急"},
