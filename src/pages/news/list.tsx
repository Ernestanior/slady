...
import {Button, Image, Space, TableColumnProps} from "antd";
            ...
            ...columns,
            {
                ...
                render(_:any, data:any){
                    return <Space>
                        ...
                        <Button onClick={() => { historyService.push(`/news/${data.uuid}`) }}>修改</Button>
                        <ConfirmButton info={`确定删除此新闻${data.title}`} submit={() => { console.log(data) }}>删除</ConfirmButton>
                    </Space>
                }
            }
        ]
